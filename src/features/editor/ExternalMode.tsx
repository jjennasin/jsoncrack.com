...
export const ExternalMode: React.FC = () => {
  // show/hide the external modal
  ...
  return (
    <>
        ...
        <Group>
          <Accordion variant="separated" w="100%">
            <Accordion.Item value="1">
              ...
              <Accordion.Panel>
                The main reason for the file size limit is to prevent performance issues, not to
                push you to upgrade. You can increase the limit by setting <Code>NEXT_PUBLIC_NODE_LIMIT</Code> in your <Code>.env</Code> file.
                <br />
                <br />
                If you&apos;d like to work with even larger files and unlock additional features,
            ...
            <Accordion.Item value="6">
              ...
              <Accordion.Panel>
                JSON Crack is a free and open-source tool for visualizing JSON data. ToDiagram is
                the professional version that offers advanced features, higher limits, and the
      ...
      {/* NodeEditModal: rendered so you can open it when a visualization node is clicked.
          Hook up your node elements to call handleNodeClick(path, value).
          Example: <div data-node-path="a.b[0]" onClick={() => handleNodeClick("a.b[0]", 123)} /> */}
      <NodeEditModal
        isOpen={!!editingNode}
